    ...
    try {
      ...
      if (commentId) {
        ...
        if (result && result.id) {
          ...
          console.error("Failed to update comment on Todoist task:", result, this.todoist.lastError);
        ...
        if (result && result.id) {
          ...
          console.error("Failed to add comment to Todoist task:", result, this.todoist.lastError);
...
async function runSourceIntegration2() {
  ...
  runSourceIntegration2 as runSourceIntegration,
